    ...
    <Section>
      ...
      <CurrentPeople>
        <Title>
          ...
          <img className="reset-button" src={resetButton} alt="reset button" onClick={handleStatusInfoReset}/>
        </Title>

        <CurrentPeopleList>
          <Person
            isHere={true}
            profileImgSrc={'http://image.dongascience.com/Photo/2017/07/14994185580021.jpg'}
            generation="22"
            name="경주원"
          />
          <Person isHere={true}/>
